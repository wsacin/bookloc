...
<html>
    ...
    <body>
        ...
        <div id="show-librarian" class="content scaffold-show" role="main">
            ...
            <f:display bean="librarian" />
            <g:form resource="${this.librarian}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.librarian}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
